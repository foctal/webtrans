...
//!
//! This module provides helpers for working with rustls crypto providers,
...
/// Compute the SHA-256 hash of a certificate using the provided crypto provider.
///
/// # Panics
///
/// Panics if the provider does not expose a SHA-256 hash algorithm.
